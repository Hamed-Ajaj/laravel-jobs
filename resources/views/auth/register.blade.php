            ...
            <div class="border-b border-gray-900/10 pb-12">
                <div class="grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6">
                    <div class="sm:col-span-4">
                        ...
                        <div class="mt-2">
                            <x-form-input id="first_name" type="text" name="first_name" placeholder="Hamed" />
                    ...
                    <div class="sm:col-span-4">
                        ...
                        <div class="mt-2">
                            <x-form-input id="last_name" type="text" name="last_name" placeholder="Ajaj" />
                    ...
                    <div class="sm:col-span-4">
                        ...
                        <div class="mt-2">
                            <x-form-input id="password_confirmation" type="password_confirmation" name="password_confirmation"/>
